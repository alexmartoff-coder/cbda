...
async def get_main_menu_keyboard(user_id: int = None):
    ...
    if not closed:
        ...
        # Flowchart says "🎁 Играть в Квиз за iPhone 17" deactivates (becomes inactive or hidden)
        # We can keep it but handle the click, or hide it.
        # The prompt says: "In the main menu, the '🎁 Play Quiz for iPhone 17' button is deactivated (becomes inactive or hidden)."
        # Let's hide it for better UX if deactivated.
        pass
