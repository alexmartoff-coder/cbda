...
async def get_main_menu_keyboard(user_id: int = None):
    ...
    progress_text = f"📊 Билетов собрано: <b>{display_count}</b> из <b>{TICKET_LIMIT}</b>\n{bar} {percent}%"
    ...
    # Bottom buttons are always visible
    buttons.append([KeyboardButton(text="📜 Правила розыгрыша"), KeyboardButton(text="🎫 Мои билеты")])
