...
async def play_button_handler(message: Message):
    ...
    mechanics_text = (
        "Порядок участия:\n"
        "1️⃣ Оплати 99 ₽.\n"
        "2️⃣ Получи 1 базовый билет.\n"
        "3️⃣ Пройди квиз (10 вопросов).\n"
        "4️⃣ Получи до +3 бонусных билетов за правильные ответы!\n\n"
        "Готовы начать?"
    )
    await message.answer(mechanics_text, reply_markup=get_payment_keyboard())
...
async def start_payment(callback: CallbackQuery):
    ...
    try:
        await callback.message.answer_invoice(
            ...
            description="1 базовый билет + до 3 бонусных билетов за квиз.",
