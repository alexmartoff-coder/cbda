...
async def show_mechanics(message: Message):
    ...
    mechanics_text = (
        ...
        "1️⃣ Оплачиваешь <b>99 ₽</b> — получаешь 1 гарантированный базовый билет.\n"
        "2️⃣ Проходишь квиз из 10 вопросов.\n"
        "3️⃣ За хорошие знания получаешь бонусные билеты:\n"
...
async def successful_payment_handler(message: Message):
    ...
    if ticket_num:
        ...
        success_text = (
            ...
            "Готов начать квиз и побороться за бонусные билеты?"
        )
