...
async def start_payment_flow(message: Message):
    ...
    mechanics_text = (
        ...
        "4. Получи до +3 бонусных билетов за правильные ответы:\n"
    ...
    kb = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="💳 Оплатить 99 ₽", callback_data="pay_99_rub")]
    ])
...
async def process_pay_99_callback(callback: CallbackQuery):
    ...
    try:
        await message.answer_invoice(
            ...
            description="Оплата участия в квизе с розыгрышем iPhone 17.",
