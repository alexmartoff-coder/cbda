...
async def play_button_handler(message: Message):
    ...
    mechanics_text = (
        ...
        "1. Оплати 99 ₽ — это даёт 1 гарантированный базовый билет.\n"
        "2. Пройди квиз из 10 вопросов — получи до +3 бонусных билетов за правильные ответы:\n"
        "   ✅ 10 ответов = +3 билета\n"
        "   ✅ 9 ответов = +2 билета\n"
        "   ✅ 8 ответов = +1 билет\n\n"
...
async def start_payment(callback: CallbackQuery):
    ...
    try:
        await callback.message.answer_invoice(
            ...
            description="Оплата участия и 1 базовый билет",
