...
async def show_mechanics(message: Message):
    ...
    mechanics_text = (
        "<b>Как получить билеты для розыгрыша iPhone 17?</b>\n\n"
        "1. Оплати участие (99 ₽).\n"
        "2. Получи 1 гарантированный базовый билет.\n"
        "3. Пройди квиз из 10 вопросов и получи бонусные билеты за знания:\n"
...
async def start_payment(callback: CallbackQuery):
    ...
    try:
        await callback.message.answer_invoice(
            ...
            description="Участие в квизе и розыгрыше iPhone 17 PRO 256 Гб.",
