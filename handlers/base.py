...
async def cmd_rules(message: Message):
    rules_html = (
        ...
        "2. Каждый платёж начисляет 1 базовый билет и запускает сессию квиза.\n"
        "3. В квизе 10 вопросов, время на ответ — 30 секунд.\n"
        ...
        "6. Розыгрыш проводится честно среди всех выданных билетов с помощью https://www.random.org/.\n\n"
