...
async def cmd_rules(message: Message):
    rules_html = (
        ...
        "1. Каждый платёж (99 ₽) даёт 1 гарантированный базовый билет.\n"
        ...
        "5. Розыгрыш проводится честно среди всех выданных билетов с помощью random.org.\n\n"
        "<b>Тематика квиза:</b> компания Apple, её устройства и история.\n"
        "<b>Приз:</b> iPhone 17.\n"
        "Участие в конкурсе означает полное согласие с <a href='https://cbda.ru/rules/base'>правилами</a>."
    )
