...
async def pay_99_handler(callback: CallbackQuery):
    from handlers.payment import start_payment
    # Call payment logic directly or simulate it
    await callback.answer()
    await start_payment(callback.message)

@router.message(F.text == "📜 Правила розыгрыша")
async def cmd_rules(message: Message):
    rules_html = (
        "<b>📌 Правила розыгрыша iPhone 17</b>\n\n"
        "<b>Тематика квиза:</b> Технологии, история Apple и общие знания.\n"
        "<b>Приз:</b> iPhone 17.\n"
        "<b>Количество билетов для завершения:</b> 2500.\n"
        "<b>Окончание сбора:</b> при достижении 2500 билетов или 10 апреля 2026.\n\n"
        "Все остальные условия — по ссылке:\n"
        "https://cbda.ru/rules/base\n\n"
        "Розыгрыш проводится честно среди всех выданных билетов через random.org."
    )
