...
async def cmd_rules(message: Message):
    rules_html = (
        ...
        "<b>Механика:</b> за оплату 99 ₽ выдаётся 1 базовый билет + возможность получить до +3 бонусных билетов в квизе (8/9/10 правильных ответов).\n"
        "<b>Лимит билетов:</b> 2500 билетов (суммарно платных и бонусных).\n"
        "<b>Старт конкурса:</b> 20 марта 2026 г.\n"
        "<b>Окончание конкурса:</b> 10 апреля 2026 г. или при достижении лимита в 2500 билетов.\n\n"
...
async def cmd_play_flow(message: Message):
    ...
    description = (
        "🎁 <b>Играть в Квиз за iPhone 17</b>\n\n"
        "Каждый платёж (99 ₽) даёт:\n"
        "1. Один гарантированный базовый билет.\n"
        "2. Возможность получить до +3 бонусных билетов за правильные ответы в квизе:\n"
        "   ✅ 10 ответов → +3 билета\n"
        "   ✅ 9 ответов → +2 билета\n"
        "   ✅ 8 ответов → +1 билет\n\n"
        "Нажми кнопку ниже, чтобы оплатить участие и начать игру!"
    )
