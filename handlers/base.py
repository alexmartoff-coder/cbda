...
async def cmd_start(message: Message):
    ...
    await message.answer(
        ...
        "Прими участие в квизе, ответь на вопросы и получи билеты на розыгрыш iPhone 17.\n\n"
        f"{progress}",
        reply_markup=kb,
        parse_mode="HTML"
    )
...
async def cmd_rules(message: Message):
    rules_html = (
        ...
        "1. <b>Как участвовать:</b> Нажмите «Играть в Квиз», оплатите 99 ₽. Вы получите 1 базовый билет и доступ к квизу.\n"
        "2. <b>Квиз:</b> 10 вопросов об Apple. 30 секунд на вопрос. За правильные ответы начисляются бонусные билеты:\n"
        "   • 10 верных — +3 билета\n"
        "   • 9 верных — +2 билета\n"
        "   • 8 верных — +1 билет\n"
        "3. <b>Сбор билетов:</b> Ограничен 2500 билетами или датой 10 апреля 2026 года.\n"
        "4. <b>Розыгрыш:</b> Проводится честно среди всех выданных билетов с помощью random.org.\n"
        "5. <b>Приз:</b> iPhone 17.\n\n"
