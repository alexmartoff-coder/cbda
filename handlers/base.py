...
async def cmd_start(message: Message):
    ...
    await message.answer(
        ...
        "Оплачивай участие, проходи квиз и получай билеты на розыгрыш!\n\n"
        f"{progress}",
        reply_markup=kb,
        parse_mode="HTML"
    )
...
async def cmd_rules(message: Message):
    rules_html = (
        ...
        "2. За квиз можно получить бонусные билеты:\n"
        "   - 10 правильных: +3 билета\n"
        "   - 9 правильных: +2 билета\n"
        "   - 8 правильных: +1 билет\n"
        "3. Сбор билетов завершается при достижении 2500 билетов или 10 апреля 2026.\n"
        "4. Победитель выбирается случайным образом через random.org среди всех выданных билетов.\n"
        "5. Розыгрыш пройдёт в прямом эфире в канале @mozgo_boy.\n\n"
...
async def cmd_leaderboard(message: Message):
    ...
    text = "🏆 <b>Лидерборд (Топ-20 по количеству билетов):</b>\n\n"
