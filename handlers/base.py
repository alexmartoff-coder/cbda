...
async def cmd_play_quiz(message: Message):
    ...
    from keyboards.menu import get_payment_keyboard
    text = (
        "<b>Механика игры:</b>\n\n"
        "1. Оплачиваешь участие (99 ₽).\n"
        "2. Получаешь 1 гарантированный базовый билет.\n"
        "3. Проходишь квиз из 10 вопросов.\n"
        "4. Получаешь бонусные билеты за правильные ответы:\n"
        "   — 10 верных: +3 билета\n"
        "   — 9 верных: +2 билета\n"
        "   — 8 верных: +1 билет\n\n"
...
async def cmd_rules(message: Message):
    rules_html = (
        ...
        "<b>Тематика квиза:</b> Apple, технологии, история компании.\n"
        "<b>Приз:</b> iPhone 17 (один экземпляр).\n"
        "<b>Участие:</b> 99 ₽.\n"
        "<b>Завершение сбора:</b> при достижении 2500 билетов или 10 апреля 2026 г.\n"
        "<b>Розыгрыш:</b> в прямом эфире с помощью random.org в канале @mozgo_boy.\n\n"
