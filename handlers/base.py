...
async def cmd_start(message: Message):
    ...
    await message.answer(
        ...
        "Оплатите участие (99 ₽), получите гарантированный билет и до +3 бонусных билетов за правильные ответы в квизе.\n\n"
        f"{progress}",
        reply_markup=kb,
        parse_mode="HTML"
    )
...
async def cmd_rules(message: Message):
    rules_html = (
        ...
        "2. За каждый платёж выдаётся 1 гарантированный билет.\n"
        ...
        "6. Победитель выбирается честно с помощью random.org.\n\n"
